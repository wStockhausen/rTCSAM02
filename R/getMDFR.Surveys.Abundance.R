#'
#'@title Get survey abundance time series from model results from TCSAM02 model runs as a dataframe
#'
#'@description Function to get survey abundance time series from model results from TCSAM02 model runs as a dataframe.
#'
