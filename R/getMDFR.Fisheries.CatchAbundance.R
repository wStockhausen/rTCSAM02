...
getMDFR.Fisheries.CatchAbundance<-function(tcsams,
    ...
    if (category=='captured'){
      ...
      mdfr1 = getMDFR.Fisheries.CatchAbundance(tcsams,category="retained",         cast=cast,verbose=verbose);
      mdfr2 = getMDFR.Fisheries.CatchAbundance(tcsams,category="discard mortality",cast=cast,verbose=verbose);
